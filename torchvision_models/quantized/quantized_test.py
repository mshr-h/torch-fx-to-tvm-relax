...
def main(args: argparse.Namespace) -> None:
  ...
  torch_model = torchvision.models.get_model(
    model_name, weights=weights, quantize=True
  ).eval()
...
if __name__ == "__main__":
  parser = argparse.ArgumentParser("torchvision quantized model example")
  parser.add_argument(
    "--model",
    type=str,
    required=True,
    choices=torchvision.models.list_models(module=torchvision.models.quantization),
  )
